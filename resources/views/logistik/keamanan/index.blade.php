    ...
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        ...
        @if ($permissions['create'])
            <div class="d-flex gap-2">
                <a href="{{ route('logistik.keamanan.import') }}" class="btn btn-success"><i
                        class="bi bi-file-earmark-excel me-1"></i> Import Excel</a>
                <a href="{{ route('logistik.keamanan.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i>
                    Tambah</a>
            </div>
        @endif
    </div>
                                    ...
                                    @if ($item->file_name)
                                        ...
                                        @else
                                            <button type="button" class="btn btn-sm btn-outline-warning"
                                                ...
                                                data-title="{{ $item->nama_kegiatan ?? $item->file_name }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        @if ($permissions['delete'] && $item->canPerformAction('delete', auth()->id()))
                                            <form action="{{ route('logistik.keamanan.destroy', $item->id) }}"
