...
@section('content')
    <div class="page-header mb-4">
        <h1 class="page-title">Detail Compliance Check</h1>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                <a href="{{ route('hukum-kepatuhan.compliance-check.index') }}" class="btn btn-outline-secondary"><i
                        class="bi bi-arrow-left"></i> Kembali</a>
                <div>
                    <a href="{{ route('hukum-kepatuhan.compliance-check.edit', $record->id) }}" class="btn btn-warning"><i
                            class="bi bi-pencil"></i> Edit</a>
                    <form action="{{ route('hukum-kepatuhan.compliance-check.destroy', $record->id) }}" method="POST"
