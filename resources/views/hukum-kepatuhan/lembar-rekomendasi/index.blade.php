    ...
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        ...
        @if ($permissions['create'])
            <div class="d-flex gap-2">
                <a href="{{ route('hukum-kepatuhan.lembar-rekomendasi.import') }}" class="btn btn-success"><i
                                    ...
                                    @if ($item->file_name)
                                        @if ($item->userHasFileAccess(auth()->id()))
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <a href="{{ route('hukum-kepatuhan.lembar-rekomendasi.download', $item->id) }}"
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        @if ($permissions['delete'] && $item->canPerformAction('delete', auth()->id()))
                                            <form
                                                action="{{ route('hukum-kepatuhan.lembar-rekomendasi.destroy', $item->id) }}"
