...
@section('content')
    <div class="page-header mb-4">
        <h1 class="page-title">Detail Aturan Kebijakan Akuntansi</h1>
    </div>
    <div class="card">
        <div class="card-body">
                            ...
                            @if ($record->file_name)
                                <div class="btn-group btn-group-sm">
                                    @if ($permissions['preview'] ?? false)
                                        <button
                                            onclick="previewFile('{{ route('akuntansi.aturan-kebijakan.preview', $record->id) }}', '{{ $record->file_name }}')"
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    @if ($permissions['edit'])
                        <a href="{{ route('akuntansi.aturan-kebijakan.edit', $record->id) }}" class="btn btn-warning"><i
