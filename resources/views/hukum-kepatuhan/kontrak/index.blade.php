...
@section('content')
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('hukum-kepatuhan.kontrak.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i>
            Tambah</a>
    </div>
    <div class="card mb-4">
        <div class="card-body">
        ...
        <div class="card-body p-0">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form action="{{ route('hukum-kepatuhan.kontrak.destroy', $item->id) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ $permissions['download'] ? 9 : 8 }}" class="text-center py-4 text-muted">Belum
                                ada data</td>
                        </tr>
                    @endforelse
                </tbody>
